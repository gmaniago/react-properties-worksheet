...
},{"./CardComponent":158,"./DateComponent":159,"./ProductBoxComponent":160,"react":156}],158:[function(require,module,exports){
"use strict";
...
module.exports = React.createClass({
	...
	render: function render() {
		return React.createElement(
			'div',
			{ className: 'product' },
			React.createElement('img', { src: this.props.image || 'http://a3.zassets.com/images/z/3/2/5/1/5/1/3251516-p-LARGE_SEARCH.jpg' }),
			React.createElement(
				'div',
				{ className: 'brand' },
				this.props.brand || 'Bostonian'
			),
			React.createElement(
				'div',
				{ className: 'name' },
				this.props.name || 'Vesey Free'
			),
			React.createElement(
				'div',
				{ className: 'price' },
				'$',
				this.props.price || '120.00'
			)
		);
	}
});
...
},{"./components/AppComponent":157,"react":156}]},{},[161])
